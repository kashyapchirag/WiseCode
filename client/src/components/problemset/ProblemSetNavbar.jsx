...
const ProblemSetNavbar = () => {
  return (
    <motion.nav className="flex justify-between items-center py-10 dark:selection:bg-cyan-400/20">
      ...
      <div className="flex font-mono justify-center items-center gap-4 border dark:selection:bg-cyan-400/20 border-green-200 bg-green-50 dark:bg-neutral-900 dark:border-neutral-900 p-3 rounded-lg ">
